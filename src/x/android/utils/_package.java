...
/**
 * \defgroup x_android_utils Utility classes
 * This group has a set of classes for general purpose.
 * Classes for debugging output, like *x.android.utils#debug* class. As for
 * simplified operations over arrays, with the *x.android.utils#arrays* class.
 *
